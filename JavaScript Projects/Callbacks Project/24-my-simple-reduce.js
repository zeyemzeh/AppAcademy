...
- Explain, but don't code, how you would refactor this problem to take in an
  ...
  “I would add a third optional parameter called initialValue to the function.
  If initialValue is provided, I would set the accumulator to this value and start the loop from index 0. 
  If initialValue is not provided, I would set the accumulator to the first element of the array and start the loop from index 1.
  This way, the function can handle both cases: when the user provides a starting accumulator or when they don't.”
*******************************************************************************/
...
mySimpleReduce([5, 3, 2, 4], function(sum, el) {
    return sum + el;
});
